...
Cloudflare Workers Router is a super lightweight router with middleware support for CloudFlare Workers, inspired by the express.js syntax, with ZERO dependencies.
